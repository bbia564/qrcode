...
class CodeThirdLogic extends GetxController {

  aboutCodePrivacy(BuildContext context) async {
...
If you have any questions or concerns about our privacy policy, please contact us via email.
  ...
  aboutCodeUS(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      children: [
        const Text(
            """We can provide you with QR code production and scanning"""),
      ],
      context: context,
    );
  }
